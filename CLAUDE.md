...
Pokyny pre Claude-based agentov pracujúcich na projekte **Proxmox Backup Manager**.

> **Primárny zdroj pokynov je [AGENTS.md](./AGENTS.md).** Prečítaj ho celý pred akoukoľvek zmenou.
> Tento súbor ho dopĺňa o poznámky špecifické pre Claude workflow.
...
- Pred väčšou zmenou zhrň plán a počkaj na potvrdenie.

### Prístup k súborom

- `app.py` má 2000+ riadkov — pri čítaní použi cielený rozsah riadkov, nie celý súbor naraz.
